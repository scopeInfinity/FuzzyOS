...
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| Stage                 |             CS |             DS |             SS |  ES |  FS |  GS | Comment                                            |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| BL_1                  |              0 |              0 |              0 |   0 |   0 |   0 | -                                                  |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| BL_2                  |              0 |              0 |              0 |   0 |   0 |   0 | -                                                  |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| KernelCore;App0       |   0x08:0x10000 |   0x10:0x10000 |   0x10:0x10000 | $DS | $DS | $DS | RealMode to ProtectedMode entry handler            |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| App2                  |   0x28:0x20000 |   0x30:0x20000 |   0x30:0x20000 | $DS | $DS | $DS |                                                    |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| App3                  | +0x10:+0x10000 | +0x10:+0x10000 | +0x10:+0x10000 | $DS | $DS | $DS |                                                    |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| ProcessScheduler;App1 |   0xAB:0x70000 |   0xAB:0x70000 |              - |     |     |     | Executed only via Interrupt Handler                |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| InterruptHandler      | $KERNEL_CS     |                |                |     |     |     | Store data from source DS to interrupt DS (if any) |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| Kernel->Interrupt     | -              |                |                |     |     |     |                                                    |
+-----------------------+----------------+----------------+----------------+-----+-----+-----+----------------------------------------------------+
| App->Interrupt        |                |                |                |     |     |     |                                                    |
